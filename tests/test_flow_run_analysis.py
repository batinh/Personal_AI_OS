...
class TestAnalyzeRunWithGemini(unittest.TestCase):
    ...
    def _apply_patches(self, analysis_text="Great run!", gcs_score=8, today_plan=None):
        ...
        response.text = json.dumps(
            {"analysis_text": analysis_text, "gcs_score": gcs_score}
        )
    ...
    def test_success_returns_analysis_text(self):
        ...
        try:
            ...
            result = analyze_run_with_gemini(
                "act_1", "Morning 10K", _make_meta_data(), _make_config()
            )
    ...
    def test_plan_found_marks_completed(self):
        ...
        try:
            ...
            mocks["update_plan_status"].assert_called_once_with(
                "123456", "2026-04-10", "Completed"
            )
        finally:
            self._stop(patchers)
    ...
    def test_meta_data_without_start_date_uses_today(self):
        ...
        try:
            ...
            analyze_run_with_gemini("act_1", "Morning 10K", meta, _make_config())
